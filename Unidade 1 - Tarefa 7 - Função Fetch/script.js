...
function criarTabela(items, propertyNames, divId) {
    ...
    async function carregarVeiculos() {
        try {
        let res = await fetch("https://random-data-api.com/api/users/random_user?size=3")
        ...
        document.getElementById("UserDiv").innerHTML = "Ocorreu um erro ao tentar pegar as informações"
    }
}
